...
OBJS = ft_arrncpy.o ft_backtr.o ft_check_nl.o ft_error_msg.o ft_find_coordinate.o \
ft_is_map_valid.o ft_is_tetramino_valid.o ft_list_del.o ft_list_delone.o \
ft_list_new.o ft_list_pushback.o ft_list_size.o ft_map_create.o ft_map_reader.o \
ft_print_map.o ft_solver.o ft_usage_file.o main.o
